...
step_time_1 = 30; % Time at which the step goes from 1 to 0
step_time_2 = 50; % Time at which the step goes from 0 to 1
step_time_3 = 70;
...
Kd = 0; % Derivative gain
tau = 0.2; % Time constant of the system
